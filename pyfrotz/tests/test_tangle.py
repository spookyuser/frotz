...
Z5_PATH = os.path.join(REPO_ROOT, "Tangle.z5")
Z8_PATH = os.path.join(REPO_ROOT, "Tangle.z8")
...
class TestTangleZ5:
    ...
    def test_unrecognized_verb(self, z5_data: bytes):
        ...
        assert "not a verb i recogni" in output.lower() or "didn't understand" in output.lower()
